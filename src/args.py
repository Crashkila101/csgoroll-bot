...
parser.add_argument("--interval", help="How many hours between each voting loop (deafult: 5)", type=int, default=24)
parser.add_argument("--width", help="Browser window width (default: 960)", type=int, default=1200)
